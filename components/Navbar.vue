    ...
    <Disclosure as="nav" class="bg-white shadow mb-8" v-slot="{ open }">
            ...
            <div class="relative flex h-16 justify-between">
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        ...
                        <a href="/login"
                            class="inline-flex items-center border-b-2 border-indigo-500 px-1 pt-1 text-sm font-medium text-gray-900">Admin</a>
                        <a href="https://www.marycargoexpress.com/rastreo-3"
                            class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">Rastrear
                            Envio</a>
        ...
        <DisclosurePanel class="sm:hidden">
            <div class="space-y-1 pb-4 pt-2">
                ...
                <DisclosureButton as="a" href="https://www.marycargoexpress.com/rastreo-3"
                    class="block border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700">
                    Rastrear Envio</DisclosureButton>
            </div>
        </DisclosurePanel>
    </Disclosure>
</template>
